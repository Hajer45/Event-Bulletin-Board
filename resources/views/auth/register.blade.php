        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Join us and start posting events today
                </p>
            </div>
        ...
        <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                autofocus 
                                autocomplete="name"
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out @error('name') border-red-500 @enderror"
